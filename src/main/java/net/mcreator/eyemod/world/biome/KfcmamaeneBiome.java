...
package net.mcreator.eyemod.world.biome;
...
import net.mcreator.eyemod.block.FriteuseBlock;
...
public class KfcmamaeneBiome extends KfcModModElements.ModElement {
	public static Biome biome;

	public KfcmamaeneBiome(KfcModModElements instance) {
		super(instance, 27);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16777216).setWaterColor(-13369600).setWaterFogColor(-13369600)
						.withSkyColor(-16777216).withFoliageColor(-16750849).withGrassColor(-65536)
						.setMusic(new BackgroundMusicSelector(
								...
								12000, 24000, true))
						.setParticle(new ParticleEffectAmbience(ParticleTypes.EXPLOSION, 0.102f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.REDSTONE_BLOCK.getDefaultState(),
								Blocks.QUARTZ_BLOCK.getDefaultState(), Blocks.SPONGE.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(FriteuseBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.BEDROCK.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("kfc_mod:kfcmamaene"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("kfcmamaene_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, Blocks.PISTON.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("kfcmamaene_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("kfcmamaene_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
					...
					for (Direction direction : Direction.Plane.HORIZONTAL) {
						if (p_225576_2_.nextFloat() <= 0.25F) {
							...
							if (Feature.isAirAt(p_225576_1_, blockpos)) {
								BlockState blockstate = Blocks.MAGENTA_BED.getDefaultState();
