...
public class CheddarrrrrrrItem extends KfcModModElements.ModElement {
	@ObjectHolder("kfc_mod:cheddarrrrrrr")
	public static final Item block = null;

	public CheddarrrrrrrItem(KfcModModElements instance) {
		super(instance, 23);
	}
