...
public class BucketoftendersItem extends KfcModModElements.ModElement {
	@ObjectHolder("kfc_mod:bucketoftenders")
	public static final Item block = null;

	public BucketoftendersItem(KfcModModElements instance) {
		super(instance, 1);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(KfcModCreativeTabItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(9).saturation(9f)
							...
							.meat().build()));
			setRegistryName("bucketoftenders");
		}
