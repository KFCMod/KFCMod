...
public class SachetItem extends KfcModModElements.ModElement {
	@ObjectHolder("kfc_mod:sachet")
	public static final Item block = null;

	public SachetItem(KfcModModElements instance) {
		super(instance, 7);
	}
