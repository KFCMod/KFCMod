...
public class PepsimeilleurquecocaBlock extends KfcModModElements.ModElement {
	@ObjectHolder("kfc_mod:pepsimeilleurquecoca")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("kfc_mod:pepsimeilleurquecoca_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public PepsimeilleurquecocaBlock(KfcModModElements instance) {
		super(instance, 6);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pepsimeilleurquecoca_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("kfc_mod:pepsimeilleurquecoca_lakes"), configuredFeature);
		}
	}
